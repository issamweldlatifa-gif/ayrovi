...
export const Footer: React.FC = () => {
  return (
    <footer className="mt-16 border-t border-[#e2e8f0] bg-white pt-12 pb-8 text-[#6b7280]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10 text-xs">
          ...
          <div className="space-y-3 md:col-span-2">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-xl bg-[#673de6] flex items-center justify-center font-black text-white text-base shadow-xs">
                A
              </div>
          ...
          <div className="space-y-2">
            <h4 className="font-bold text-[#1d2130] text-sm">Boutiques Partenaires</h4>
          ...
          {/* Col 3 */}
          <div className="space-y-2">
            <h4 className="font-bold text-[#1d2130] text-sm">Taux & Transparence</h4>
            <ul className="space-y-1.5 text-[#6b7280]">
              <li>💶 1 EUR = 4.00 DT</li>
              <li>💵 1 USD = 4.00 DT</li>
        ...
        {/* Bottom Bar */}
        <div className="pt-6 border-t border-[#f1f3f9] flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left text-[11px] text-[#9ca3af]">
          <p>© {new Date().getFullYear()} AYROVI. Tous droits réservés — Tunisie 🇹🇳.</p>
          <p className="flex items-center gap-1">
            Conçu avec <Heart className="w-3 h-3 text-[#673de6] fill-[#673de6]" /> pour faciliter vos achats en Tunisie.
          </p>
        </div>
